...
INSERT INTO consultas (id, animal_id, veterinario_id, data_hora, diagnostico, valor, status) VALUES 
(1, 1, 1, '2024-05-01 09:00:00', 'Checkup de rotina', 150.00, 'concluida'),
(2, 2, 2, '2024-05-02 10:30:00', 'Vacinação', 120.00, 'concluida'),
(3, 3, 3, '2024-05-03 14:00:00', 'Corte de asas', 80.00, 'concluida'),
(4, 3, 3, '2024-05-04 11:00:00', 'Análise de água', 90.00, 'concluida'),
(5, 3, 3, '2024-05-05 16:00:00', 'Troca de pele', 130.00, 'concluida'),
(6, 1, 1, '2024-05-06 09:30:00', 'Dermatite', 200.00, 'concluida'),
(7, 2, 2, '2024-05-07 13:00:00', 'Castração', 500.00, 'concluida'),
(8, 1, 1, '2024-05-08 15:30:00', 'Limpeza de tártaro', 350.00, 'concluida'),
(9, 2, 2, '2024-05-09 10:00:00', 'Suspeita de fratura', 400.00, 'cancelada'),
(10, 3, 3, '2024-05-10 14:30:00', 'Ajuste de bico', 100.00, 'concluida'),
(11, 1, 1, '2024-05-11 08:00:00', 'Exame de sangue', 180.00, 'concluida'),
(12, 3, 3, '2024-05-12 11:30:00', 'Fungo nas barbatanas', 110.00, 'concluida'),
(13, 3, 3, '2024-05-13 16:30:00', 'Falta de apetite', 140.00, 'concluida'),
(14, 1, 1, '2024-05-14 09:00:00', 'Dor articular', 220.00, 'concluida'),
(15, 2, 2, '2024-05-15 13:30:00', 'Otite', 160.00, 'concluida'), 
(16, 1, 1, '2024-06-01 10:00:00', 'Retorno checkup', 0.00, 'agendada'),
(17, 2, 2, '2024-06-02 14:00:00', 'Reforço vacina', 120.00, 'agendada'),
(18, 6, 1, CONCAT(CURDATE(), ' 09:00:00'), 'Acompanhamento dermatite', 200.00, 'em_atendimento'),
(19, 7, 2, CONCAT(CURDATE(), ' 11:30:00'), 'Retorno castração', 0.00, 'agendada'),
(20, 11, 1, CONCAT(CURDATE(), ' 15:00:00'), 'Avaliação de exames', 150.00, 'agendada');
...
(15, 0.00, 'cartao', NULL, 'pendente'), 
(16, 0.00, 'convenio', '2024-06-01 10:30:00', 'pago'),
(17, 120.00, 'pix', NULL, 'pendente'),
(18, 0.00, 'cartao', NULL, 'pendente'), 
(19, 0.00, 'convenio', NULL, 'pendente'), 
(20, 0.00, 'dinheiro', NULL, 'pendente'); 
...
## Campos: 
## id, 
## nome (UNIQUE) — Pré-populado com Cachorro, Gato, Pássaro, Peixe, Réptil.
...
## diagnostico, 
## valor, 
## status (ENUM: 'agendada', 'em_atendimento', 'concluida', 'cancelada').

## pagamentos: Fluxo financeiro das consultas.

## Campos: 
## id, 
## consulta_id (FK UNIQUE), 
## valor_pago, 
## forma_pagamento (ENUM: 'pix', 'cartao', 'dinheiro', 'convenio'), 
## data_pagamento, 
